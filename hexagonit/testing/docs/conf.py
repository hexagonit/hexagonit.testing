...
htmlhelp_basename = 'hexagonit.testingdoc'
...
latex_documents = [
  ('index', 'hexagonit.testing.tex', u'hexagonit.testing Documentation',
   u'Hexagon IT', 'manual'),
]
...
man_pages = [
    (
        'index',
        'todo',
        u'hexagonit.testing Documentation',
        [u'Hexagon IT'],
        1)]
